...
<div id="container">
	...
	<form id="coupon">
		...
		<p id="coupon-top"> 
			...
			<input type=button id="buttonDownload" value="쿠폰 다운로드"> <br /> <br /><br />
		</p> 
		<div id="mainCoupon">

			<input type=button id="button1"onclick="function_click(this);" value="사용 가능한 쿠폰"><input
				type=button id="button2" onclick="function_click(this);"value="사용 완료된 쿠폰"> <br />
			<br>
