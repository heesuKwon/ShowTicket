...
<link href="https://fonts.googleapis.com/css?family=Gothic+A1&display=swap" rel="stylesheet">
	...
	<div class="t_background">
		...
		<div class="nav nav-pills nav-justified tnav_margin">
			...
			<li class="nav-item"><a class="nav-link default nav-font" href="#">할인/매수선택</a></li>
		...
		<div class="t_cdiv1">
			<!-- 우선 이미지와 내용들은 임시로 넣어뒀습니다. 바꿔서 사용하세요~  -->
			<p class="t_cgenre">뮤지컬</p> <p class="t_cname"> &lt;정글라이프&gt;</p>
			<img src="${pageContext.request.contextPath }/resources/images/jungle.jpg" alt="공연 이미지" class="t_cimg"/>		
		</div>
		<div class="t_cdiv2">
			...
			<input type="checkbox" class="t_checkbox"/>
			<p class="t_checkboxtext">취소 기한 및 취소 수수료 동의</p>
			
			<div class="t_cbtndiv">
				<input type="button" value="이전단계" class="t_button1" onclick="location.href='${pageContext.request.contextPath}/ticketing/ticketingPoint.do'"/>
