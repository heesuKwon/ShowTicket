...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/showdetail.css">
...
<script>
    ...
    <meta property="og:url" content="http://www.ticketlink.co.kr/product/29652"/>
    <meta property="og:description"
          content="뮤지컬 <사랑했어요> (사랑의 가객 故김현식 뮤지컬) "/>
    <meta property="og:image" content="//image.toast.com/aaaaab/ticketlink/TKL_6/SPST_0905.jpg"/>
    ...
    <div id="container">
        <input type="hidden" id="productId" value="29652"/>
        <input type="hidden" id="productName" value="뮤지컬 <사랑했어요> (사랑의 가객 故김현식 뮤지컬) "/>
        <input type="hidden" id="adultYn" value="false"/>
        <div class="inner">
            <h2 class="blind">공연</h2><!-- [D]  1 depth의 값을 h2로 뿌려줍니다 -->
            <h3 class="blind">뮤지컬</h3><!-- [D]  2 depth의 값을 h3로 뿌려줍니다 -->
            ...
            <div class="detail_box_top ">
                ...
                <div class="detail_info">
                    <div class="bx_thumb">
                        <span class="bx_img">
                        <!-- 뮤지컬포스터 -->
                            <img src="//image.toast.com/aaaaab/ticketlink/TKL_6/SPST_0905.jpg" alt="대표이미지" width="314" height="382">
                        </span>
                    </div>
                    <div class="etc_info">
                                ...
                                <div class="bx_dummy">
                                    <em class="info_tit">장소</em>
                                    <span class="txt">성남아트센터 오페라하우스</span>
                                </div>
                                <div class="bx_dummy">
                                    <em class="info_tit">기간</em>
                                    <span class="txt">2019.09.20~2019.10.27</span>
                                </div>
                            
                        
                        
                            <div class="bx_dummy">
                                <em class="info_tit">관람시간</em>
                                <span class="txt">135분</span>
                            </div>
                                ...
                                <div class="bx_dummy border_type">
                                    <em class="info_tit">관람등급</em>
                                    <span class="txt">만7세이상</span>
                                </div>
                            ...
                            <div class="bx_dummy include_layer border_type">
                                ...
                                <div class="txt ui-dialog  price-dialog">
                                    <ul class="lst_dsc">
                                            ...
                                            <li>쿠폰할인 - <span class="color_purple fbold ">30</span>%
                                                
                                                 할인 
                                                </li>
                                        
                                            <li><사랑했어요>기대평 이벤트 - <span class="color_purple fbold">40</span>%
                    ...
                    <ul class="addList">
                        <li class="favorite"><span>관</span></li>
                        <li class="wait"><span>대</span></li>
                    </ul>
                                ...
                                <dl class="dotline_x">
                                    ...
                                    <dd >
                                        <ul class="seat" id="seatingInfoPerRound">
                                        	<li>전체 <span class="color_purple fbold">427</span>석 </li>
                                        	<br />
      		                                <li>VIP석 <span class="color_purple fbold">427</span>석 </li>
                                        	<br />
                                        	<li>R석 <span class="color_purple fbold">427</span>석 </li>
                                        	<br />
                                        	<li>S석 <span class="color_purple fbold">427</span>석 </li>
                                        	<br />
                                        	<li>A석 <span class="color_purple fbold">427</span>석 </li>
                                        </ul>
                                    </dd>
                                </dl>
                                        ...
                                        <button type="button" class="btn reserve s_after first-child" onclick=""><span>예매하기
                                        </span></button>
...
<link rel="stylesheet" type="text/css" href="http://ticketlink.dn.toastoven.net/web/pcweb/markup_resources/201506191200/jindoStarRating/css/star.css">
...
<div class="detail_cont detail_cont_v2">
    <div class="title_wrap">
        ...
        <a href="javascript:;" onclick="popupBoardRule();" class="btn_text2">게시판 운영규정<em></em></a>
    </div>
    <p class="guide_txt">
        네티즌 별점 및 후기 게시판에 티켓 양도와 매매성 등 글과 같이 게시판 성격에 벗어난 글을 게재할 경우 사전 통보 없이 삭제될
        수 있습니다.<br> 티켓 양도 및 매매의 경우 전화번호, 이메일 등의 개인정보가 악용될 소지가 있으므로 게재를 삼가
        주시기 바랍니다.<br> 운영 규정을 지속적으로 어기는 게시글을 게재할 경우 티켓링크 게시판 이용이 제한될 수
        있습니다.
    </p>
    ...
    <div class="star_review" id="star_review">
        <fieldset>
            ...
            <div class="star_rating">
                ...
                <div class="starrating-background" id="star_rating" style="float: left;">
                    <span><em></em></span>
                </div>
                <span class="blind">평점</span> <span class="star_score" id="score" name="rating"></span>
            </div>

            <dl class="star_average">
                <dt>현재 평균 별점</dt>
                <dd class="grade" id="ratingAverage">
                    점
                </dd>
                <dd class="grade_star">
                    <span class="star_gauge" id="ratingAverageStar" style="width: 0%"></span>
                </dd>
                <dd class="bar">|</dd>
                <dt>참여인원</dt>
            ...
            <div class="write_review">
				<textarea title="후기 작성하기" id="reviewContent" name="reviewContent" onclick="callMemberCommonCheck();" onkeyup="checkTextLength(this);"
                          onpaste="checkTextLength(this);" onchange="checkTextLength(this);" style="height: 25px; resize:none;" maxlength="3000"
    ...
    <div class="title_wrap mgt40">
        <strong class="title title22 fl">후기보기</strong>
        <a href="javascript:;" class="btn_text3 fr" id="displayAllReviewBtn" onclick="displayAllreview();">전체후기보기</a>
    </div>
    ...
    <div class="list_search">
        <div class="selectbox selectbox_v2" id="review_search_div">
            <a href="javascript:;" id="review_search_option" onclick="openReviewSelectList();" class="select">아이디</a>
            <input type="hidden" id="review_search_type" value="memberId">
            <ul class="select_list" id="review_select_list" style="display:;">
                <li><a href="javascript:;" onclick="closeReviewSelectList(this)">아이디</a></li>
                <li><a href="javascript:;" onclick="closeReviewSelectList(this)">내용</a></li>
            </ul>
        </div>
        <div class="input_field">
            <input type="text" title="검색어 입력" id="review_search_key">
            <a href="javascript:;" onclick="searchReview();" class="btn_search">찾기</a>
        </div>
    </div>
</div>

<script type="text/javascript" src="http://ticketlink.dn.toastoven.net/web/pcweb/markup_resources/201506191200/jindoStarRating/js/jindo.js"></script>
<script type="text/javascript" src="http://ticketlink.dn.toastoven.net/web/pcweb/markup_resources/201506191200/jindoStarRating/js/jindo.Component.js"></script>
<script type="text/javascript" src="http://ticketlink.dn.toastoven.net/web/pcweb/markup_resources/201506191200/jindoStarRating/js/jindo.UIComponent.js"></script>
<script type="text/javascript" src="http://ticketlink.dn.toastoven.net/web/pcweb/markup_resources/201506191200/jindoStarRating/js/jindo.StarRating.js"></script>
<script type="text/javascript">
	//<![CDATA[
...
<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=ebd2punvyx"></script>
...
<div class="detail_cont">
        ...
        <div class="contents">
            장소 : 성남아트센터 오페라하우스<br>
            주소 : 경기도 성남시 분당구 야탑동 757 성남아트센터<br>
            ...
            <div class="map_wrap">
                ...
                <div class="bx">
                    <a href="" target="_blank" class="btn_map" id="go_to_naver_map">빠른길 찾기</a>
                </div>
            </div>
...
<div class="detail_cont">
        ...
        <div class="contents">
                <p><strong><span style="font-family: 돋움, dotum;">1) 일반배송</span></strong><br><span style="font-family: 돋움, dotum;">						티켓 예매 확인 후 인편으로 배송되며, 예매 후 10일 이내(영업일 기준) 수령 가능합니다.</span><br><span style="font-family: 돋움, dotum;">일괄 배송 상품의 경우 고지된 배송일 이후 10일 이내(영업일 기준) 수령 가능합니다.</span><br><span style="font-family: 돋움, dotum;">배송비는 행사에 따라&nbsp;상이합니다. 상품 상세 페이지 안내에서 확인할 수 있습니다. </span><br><span style="font-family: 돋움, dotum;">행사 또는 행사일에 따라 우편배송 방법의 선택이 제한될 수 있습니다.</span></p><p><span style="font-family: 나눔고딕, NanumGothic, sans-serif;"></span><br><strong><span style="font-family: 돋움, dotum;">2) 현장수령</span></strong><br><span style="font-family: 돋움, dotum;">						행사당일 공연 시작 1시간~30분 전까지 행사장 매표소에서 수령하실 수 있습니다.</span><br><span style="font-family: 돋움, dotum;">예매번호, 예매하신 분의 신분증(필수), 예매확인서(프린트 또는, 티켓링크 앱 예매확인 페이지)를&nbsp;매표소에 제시하시면 편리하게 티켓을 수령하실 수 있습니다.</span><br><span style="font-family: 돋움, dotum;">행사 또는 행사일에 따라 현장수령 방법의 선택이 제한될 수 있습니다.</span><br><span style="font-family: 돋움, dotum;">수령장소는 각 행사장 매표소이며, 매표소의 예매자 전용 창구를 이용하시면 됩니다.&nbsp;</span></p>
        </div>
    
    
        <strong>[예매 취소 안내]</strong>
        <div class="contents">
                <strong>예매 취소 시 주의사항</strong><br>	 티켓 예매 후 7일 이내에 취소 시, 취소수수료가 없습니다. <br>단, 예매 후 7일 이내라도 취소 시점이 공연일로부터 10일 이내라면 그에 해당하는 취소수수료가 부과됩니다.<br>예매 당일 자정(12:00) 전에 취소할 경우 예매 수수료가 환불되며, 그 이후에는 환불되지 않습니다.<br>예매티켓 취소는 아래 안내된 취소가능일 이내에만 할 수 있습니다.	 <table class="detail_info_tbl mgt15"><caption>예매 취소 안내</caption><colgroup><col style="width: 180px;"><col style="width: 130px;"><col></colgroup><thead><tr><th rowspan="1" colspan="1" scope="col">행사일</th><th rowspan="1" colspan="1" scope="col">배송방법</th><th rowspan="1" colspan="1" scope="col">취소가능시간</th></tr></thead><tbody><tr><td rowspan="2">평일/토요일</td><td>현장수령</td><td>행사 전 일, 17:00까지</td></tr><tr><td>인편배송</td><td>행사 전 일, 17:00까지 반송하여 도착하는 티켓</td></tr><tr><td rowspan="2">일요일</td><td>현장수령</td><td>행사 전 토요일, 17:00까지</td></tr><tr><td>인편배송</td><td>행사 전 토요일, 11:00까지 반송하여 도착하는 티켓</td></tr><tr><td rowspan="2">행사전일 : 평일<br>행사일 : 연휴기간/연휴다음날</td><td>현장수령</td><td>행사 전 일, 17:00까지</td></tr><tr><td>인편배송</td><td>행사 전 일, 17:00까지 반송하여 도착하는 티켓</td></tr><tr><td rowspan="2">행사전일 : 토요일<br> 행사일 : 연휴기간/연휴다음날</td><td>현장수령</td><td>연휴 전 토요일, 17:00까지</td></tr><tr><td>인편배송</td><td>연휴 전 토요일, 11:00까지 반송하여 도착하는 티켓</td></tr></tbody></table><p>단, 롯데콘서트홀 공연의 경우 관람일 하루 전 18:00까지 취소 가능하며 토/일/월 공연의 경우 금요일 18:00까지 취소 가능합니다.&nbsp;</p><p>&nbsp;</p><p>구입하신 예매채널을 통해서만 취소가 가능합니다. (티켓링크에서는 티켓링크에서 예매한 티켓만 취소 가능합니다.) <br>구입하신 티켓의 일부분 취소, 날짜/시간/좌석등급/좌석위치 변경은 불가능합니다. (관련 상담 : 티켓링크 콜센터 1588-7890)<br>반송 시, 고객님의 예매번호와 연락처, 반송사유, 환불계좌, 예금주를 적으셔서 티켓과 동봉해 보내주시면 정확한 처리에<br> 도움이 됩니다.<br>취소 가능 시간이 공연일까지 3일 이상 남지 않았을 경우 특급우편을 이용하거나 콜센터 1588-7890으로 문의 바랍니다.<br>발송 받으신 티켓이 분실되거나 훼손되었을 경우 취소 및 변경이 절대 불가합니다.<br>공연상의 문제로 환불을 받으실 경우 별도의 수수료를 공제하지 않으며, 환불 주체가 티켓링크가 아닌 행사 주최사가 <br>될 수 있습니다.</p><p><strong>취소수수료 안내</strong><br>무통장 입금으로 결제하신 경우, 취소수수료와 송금수수료 500원을 제외한 나머지 금액이 고객 환불 계좌에 입금됩니다.<br>환불은행, 계좌번호, 예금주는 본인명의로 정확히 입력 부탁드리며, 취소처리를 접수한 날로부터 3~5일 이내에 환불 받으실 수 있습니다.<br>
또한, 타인의 계좌를 이용하거나 명의를 도용했을 경우 서비스 이용이 제한될 수 있습니다.<br>신용카드로 결제 시, 취소수수료 및 우편 발송비를 재승인 후 기존 승인금액을 취소 처리합니다.
</p><table class="detail_info_tbl mgt15"><caption></caption><colgroup><col style="width: 86px;"><col style="width: 163px;"><col style="width: 180px;"><col></colgroup><thead><tr><th rowspan="1" colspan="2" scope="col">행사일</th><th rowspan="1" colspan="1" scope="col">취소수수료 (인터넷, 콜센터)</th><th rowspan="1" colspan="1" scope="col">비고</th></tr></thead><tbody><tr><th rowspan="5" colspan="1">공연 / 전시</th><td>예매후 7일 이내 / 예매당일</td><td>없음</td><td rowspan="7">예매 당일에 취소하는 경우 이외에는<br>예매수수료가 환불되지 않음 (약관 28조 의거)<br><br>예매 후 7일 이내라도 취소 시점이 공연일로부터<br>10일 이내라면 그에 해당하는 취소수수료가 부과됨<br>(약관 32조 의거)</td></tr><tr><td>예매후 8일 ~ 관람일 10일 전</td><td>뮤지컬, 콘서트, 클래식 등 공연권<br>: 장당 4,000원<br>	 연극, 전시 등 입장권 <br>	 장당 2,000원<br>* 티켓금액의 10% 이내</td></tr><tr><td>관람일 9일 전 ~ 7일 전</td><td>티켓금액의 10%</td></tr><tr><td>관람일 6일 전 ~ 3일 전</td><td>티켓금액의 20%</td></tr><tr><td>관람일 2일 전 ~ 1일 전</td><td>티켓금액의 30%</td></tr><tr><th rowspan="1" colspan="2" scope="row">스포츠</th><td>티켓 구매 금액의 10%</td></tr></tbody></table>
...
<div id="footer">
    ...
    <script type="text/javascript">
		$("iframe[name='google_conversion_frame']").css("display", "none");
                ...
                <!-- 다이얼로그 창  -->
                <div class="layer l_installment popup" id="dialog1" style="display: none">
                    <a href="javascript:;" onclick="$('#dialog1').dialog('close');" class="close">레이어 닫기</a> <strong>무이자 할부</strong>
                    <table>
                ...
                <div class="layer l_installment popup" id="dialog4" style="display: none">
                    <a href="javascript:;" onclick="$('#dialog4').dialog('close');" class="close">레이어 닫기</a> <strong>가격정보</strong>
                    <ul class="fs11">
                        
                            VIP석 - <span class="num">140,000</span>원<br>
                        
                            R석 - <span class="num">120,000</span>원<br>
                        
                            S석 - <span class="num">90,000</span>원<br>
                        
                            A석 - <span class="num">60,000</span>원<br>
                        
                    </ul>
                </div>

                <div class="layer l_installment popup" id="dialog5" style="display: none">
                    <a href="javascript:;" onclick="$('#dialog5').dialog('close');" class="close">레이어 닫기</a> <strong>가격정보</strong>
                    <ul class="fs11">
                        
                            일반 - <span class="num">140,000</span>원<br>
                            </span>
                        
                    </ul>
                </div>

                <div class="layer l_installment popup" id="dialog7" style="display: none">
                    <a href="javascript:;" onclick="$('#dialog7').dialog('close');" class="close">레이어 닫기</a> <strong>할인정보</strong>
                    <ul class="fs11">
                        
                            <li>
                                    추억만들기 - <span class="color_green fbold">30</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    초연기념특별할인 - <span class="color_green fbold">40</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    마티네 할인 - <span class="color_green fbold">30</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    뮤지컬 <사랑했어요> 실물 유료 티켓 소지자 (재관람 할인) - <span class="color_green fbold">20</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    학생 할인 (초,중,고) - <span class="color_green fbold">20</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    학생 할인 (초,중,고) - <span class="color_green fbold">30</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    대학생 할인 - <span class="color_green fbold">20</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    대학생 할인 - <span class="color_green fbold">30</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    장애인 1-3급(1인 2매) - <span class="color_green fbold">50</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    장애인 4-6급(1인 1매) - <span class="color_green fbold">50</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    국가유공자(1인 1매) - <span class="color_green fbold">50</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    경기도 성남시 거주자 및 직장인할인 - <span class="color_green fbold">20</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    4인 이상 - <span class="color_green fbold">30</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
                            ...
                            <li>
                                    영피프티(50세 이상) - <span class="color_green fbold">40</span><span class="color_green fbold">
                                %
                                </span>
                                 할인 
                            </li>
...
<script type="text/javascript" src="/resources/js/jquery.placeholder.min.js"></script>
<script type="text/javascript" src="/resources/js/coupon/couponCodeType.js"></script>
<script type="text/javascript" src="/resources/js/coupon/couponTemplate.js"></script>
